...
insert into hobbies value ('그림그리기', 'ANY', 'indoor', 'solo', 'play', 'static', 'healing', 'no', 'yes', 'fun', 'normal');
...
insert into hobbies value ('낚시', '낚시터',  'outdoor', 'ANY', 'play', 'normal', 'healing', 'no', 'yes', 'fun', 'normal');
...
insert into hobbies value ('수영', '수영장', 'ANY', 'solo', 'play', 'dynamic', 'burning', 'no', 'yes', 'fun', 'normal');
-- 농구, 배구, 축구, 풋살, 야구, 골프, 볼링, 당구, 포켓볼, 복싱, 레슬링, 유도, 태권도, 가라데, 검도, 펜싱, 
insert into hobbies value ('농구', '농구장', 'ANY', 'multi', 'play', 'dynamic', 'burning', 'yes', 'yes', 'fun', 'normal');
insert into hobbies value ('배구', '체육관', 'indoor', 'multi', 'play', 'dynamic', 'burning', 'yes', 'yes', 'fun', 'normal');
insert into hobbies value ('축구', '축구장', 'outdoor', 'multi', 'play', 'dynamic', 'burning', 'yes', 'yes', 'fun', 'normal');
insert into hobbies value ('풋살', '풋살장', 'indoor', 'multi', 'play', 'dynamic', 'burning', 'yes', 'yes', 'fun', 'normal');
insert into hobbies value ('야구', '야구장', 'outdoor', 'multi', 'play', 'normal', 'burning', 'yes', 'yes', 'fun', 'normal');
insert into hobbies value ('골프', '골프장', 'outdoor', 'multi', 'play', 'normal', 'burning', 'yes', 'yes', 'fun', 'normal');
insert into hobbies value ('볼링', '볼링장', 'indoor', 'ANY', 'play', 'normal', 'burning', 'no', 'no', 'fun', 'normal');
insert into hobbies value ('당구', '당구장', 'indoor', 'ANY', 'play', 'normal', 'burning', 'no', 'no', 'fun', 'normal');
insert into hobbies value ('포켓볼', '당구장', 'indoor', 'ANY', 'play', 'normal', 'burning', 'no', 'no', 'fun', 'normal');
insert into hobbies value ('복싱', '복싱클럽', 'indoor', 'multi', 'play', 'dynamic', 'burning', 'yes', 'no', 'fun', 'normal');
insert into hobbies value ('주짓수', '주짓수체육관', 'indoor', 'multi', 'play', 'dynamic', 'burning', 'yes', 'no', 'fun', 'normal');
insert into hobbies value ('레슬링', '레슬링체육관', 'indoor', 'multi', 'play', 'dynamic', 'burning', 'yes', 'no', 'fun', 'special');
insert into hobbies value ('유도', '유도장', 'indoor', 'multi', 'play', 'dynamic', 'burning', 'yes', 'no', 'fun', 'normal');
insert into hobbies value ('태권도', '태권도장', 'indoor', 'ANY', 'play', 'dynamic', 'burning', 'yes', 'no', 'fun', 'normal');
insert into hobbies value ('가라데', '가라데도장', 'indoor', 'ANY', 'play', 'dynamic', 'burning', 'yes', 'no', 'fun', 'special');
insert into hobbies value ('검도', '검도장', 'indoor', 'multi', 'play', 'dynamic', 'burning', 'yes', 'yes', 'fun', 'normal');
...
insert into hobbies value ('테니스', '테니스장', 'ANY', 'multi', 'play', 'dynamic', 'burning', 'yes', 'yes', 'fun', 'normal');
insert into hobbies value ('탁구', '탁구장', 'indoor', 'multi', 'play', 'dynamic', 'burning', 'yes', 'yes', 'fun', 'normal');
insert into hobbies value ('배드민턴', '배드민턴센터', 'ANY', 'multi', 'play', 'dynamic', 'burning', 'yes', 'yes', 'fun', 'normal');
insert into hobbies value ('스쿼시', '스쿼시클럽', 'indoor', 'ANY', 'play', 'dynamic', 'burning', 'yes', 'yes', 'fun', 'normal');
-- 양궁, 스키, 스케이트보드, 스노우보드, 아이스스케이트, 롤러스케이트,
insert into hobbies value ('양궁', '양궁장', 'ANY', 'solo', 'play', 'normal', 'burning', 'yes', 'no', 'fun', 'normal');
insert into hobbies value ('스키', '스키장', 'outdoor', 'solo', 'play', 'dynamic', 'burning', 'no', 'no', 'fun', 'normal');
insert into hobbies value ('스케이트보드', '스케이크파크', 'outdoor', 'solo', 'play', 'dynamic', 'burning', 'no', 'yes', 'fun', 'normal');
insert into hobbies value ('스노우보드', '스키장', 'outdoor', 'solo', 'play', 'dynamic', 'burning', 'no', 'no', 'fun', 'normal');
insert into hobbies value ('아이스스케이트', '아이스링크', 'indoor', 'solo', 'play', 'dynamic', 'burning', 'no', 'no', 'fun', 'normal');
insert into hobbies value ('롤러스케이트', '롤러스케이트장', 'ANY', 'solo', 'play', 'dynamic', 'burning', 'no', 'no', 'fun', 'normal');
-- 춤, 노래, 악기연주, 
insert into hobbies value ('춤', 'ANY', 'ANY', 'solo', 'play', 'dynamic', 'burning', 'no', 'no', 'fun', 'normal');
insert into hobbies value ('노래', 'ANY', 'ANY', 'solo', 'play', 'normal', 'burning', 'no', 'no', 'fun', 'normal');
insert into hobbies value ('악기연주', 'ANY', 'ANY', 'solo', 'play', 'normal', 'burning', 'no', 'yes', 'fun', 'normal');
...
insert into hobbies value ('전시회관람', '전시회장', 'indoor', 'solo', 'watch', 'static', 'healing', 'yes', 'no', 'fun', 'normal');
insert into hobbies value ('미술관관람', '미술관', 'indoor', 'solo', 'watch', 'static', 'healing', 'yes', 'no', 'fun', 'normal');
insert into hobbies value ('클래식관람', '클래식공연장', 'indoor', 'solo', 'watch', 'static', 'healing', 'yes', 'no', 'fun', 'normal');
insert into hobbies value ('콘서트관람', '콘서트장', 'ANY', 'solo', 'watch', 'static', 'healing', 'yes', 'no',  'fun', 'normal');
insert into hobbies value ('스포츠관람', '야구장', 'ANY', 'solo', 'watch', 'static', 'healing', 'yes', 'no', 'fun', 'normal');
...
-- 외국어공부, 주식공부,
insert into hobbies value ('요리', 'ANY', 'indoor', 'solo', 'play', 'static', 'healing', 'no', 'yes', 'fun', 'normal');
insert into hobbies value ('베이킹', 'ANY', 'indoor', 'solo', 'play', 'static', 'healing', 'no', 'yes', 'fun', 'normal');
...
insert into hobbies value ('도자기공예', '도자기공방', 'indoor', 'solo', 'play', 'static', 'healing', 'yes', 'yes', 'fun', 'special');
...
insert into hobbies value ('스쿠버다이빙', '스쿠버', 'outdoor', 'ANY', 'play', 'dynamic', 'burning', 'yes', 'no', 'fun', 'special');
