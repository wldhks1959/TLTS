...
insert into hobbies value ('캠핑', '캠핑장', 'outdoor', null, 'play', 'normal', 'healing', 'no', 'yes', 'fun', 'normal');
insert into hobbies value ('낚시', '낚시터',  'outdoor', null, 'play', 'normal', 'healing', 'no', 'yes', 'fun', 'normal');
...
insert into hobbies value ('사이클링', null, 'outdoor', 'solo', 'play', 'dynamic', 'burning', 'no', 'yes', 'fun', 'normal');
insert into hobbies value ('서핑', '해수욕장', 'outdoor', 'solo', 'play', 'dynamic', 'burning', 'no', 'yes', 'fun', 'normal');
insert into hobbies value ('수영', null, 'solo', 'play', 'dynamic', 'burning', 'no', 'yes', 'fun', 'normal');
-- 농구, 배구, 축구, 풋살, 야구, 골프, 볼링, 당구, 포켓볼, 복싱, 레슬링, 유도, 태권도, 가라데, 검도, 펜싱, 
insert into hobbies value ('농구', null, 'multi', 'play', 'dynamic', 'burning', '', 'yes', 'fun', '');
insert into hobbies value ('배구', 'indoor', 'multi', 'play', 'dynamic', 'burning', '', 'yes', 'fun', '');
insert into hobbies value ('축구', 'outdoor', 'multi', 'play', 'dynamic', 'burning', '', 'yes', 'fun', '');
insert into hobbies value ('풋살', 'indoor', 'multi', 'play', 'dynamic', 'burning', '', 'yes', 'fun', '');
insert into hobbies value ('야구', 'outdoor', 'multi', 'play', 'normal', 'burning', '', 'yes', 'fun', '');
insert into hobbies value ('골프', 'outdoor', 'multi', 'play', 'normal', 'burning', '', 'yes', 'fun', '');
insert into hobbies value ('볼링', 'indoor', null, 'play', 'normal', 'burning', '', '', 'no', 'fun', '');
insert into hobbies value ('당구', 'indoor', null, 'play', 'normal', 'burning', '', '', 'no', 'fun', '');
insert into hobbies value ('포켓볼', 'indoor', null, 'play', 'normal', 'burning', '', '', 'no', 'fun', '');
insert into hobbies value ('복싱', 'indoor', 'multi', 'play', 'dynamic', 'burning', '', '', '', 'fun', '');
insert into hobbies value ('레슬링', 'indoor', 'multi', 'play', 'dynamic', 'burning', '', '', '', 'fun', '');
insert into hobbies value ('유도', 'indoor', 'multi', 'play', 'dynamic', 'burning', '', '', '', 'fun', '');
insert into hobbies value ('태권도', 'indoor', null, 'play', 'dynamic', 'burning', '', '', '', 'fun', '');
insert into hobbies value ('가라데', 'indoor', null, 'play', 'dynamic', 'burning', '', '', '', 'fun', '');
insert into hobbies value ('검도', 'indoor', 'multi', 'play', 'dynamic', 'burning', '', '', '', 'fun', '');
insert into hobbies value ('펜싱', 'indoor', 'multi', 'play', 'dynamic', 'burning', '', 'yes', '', 'fun', '');
-- 러닝, 요가, 필라테스, 헬스, 크로스핏, 파워리프팅, 테니스, 탁구, 배드민턴, 스쿼시, 
insert into hobbies value ('러닝', null, 'solo', 'play', 'dynamic', 'burning', '', '', '', 'fun', '');
insert into hobbies value ('요가', 'indoor', 'solo', 'play', 'normal', 'healing', '', '', '', 'self development', '');
insert into hobbies value ('필라테스', 'indoor', 'solo', 'play', 'normal', 'burning', '', '', '', 'self development', '');
insert into hobbies value ('헬스', 'indoor', 'solo', 'play', 'dynamic', 'burning', 'no', '', '', 'self development', '');
insert into hobbies value ('크로스핏', 'indoor', 'solo', 'play', 'dynamic', 'burning', 'no', '', '', 'self development', '');
insert into hobbies value ('파워리프팅', 'indoor', 'solo', 'play', 'dynamic', 'burning', 'no', '', '', 'self development', '');
...
insert into hobbies value ('독서', 'indoor', 'solo', 'play', 'static', 'healing', 'no', '', '', 'self development', '');
